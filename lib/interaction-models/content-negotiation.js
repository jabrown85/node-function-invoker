...
const SUPPORTED_MEDIA_TYPES = ['text/plain', 'application/octet-stream', 'application/json', 'application/cloudevents+json', 'application/x-www-form-urlencoded']; // In preference order
...
const mediaTypeMarshallers = {
    ...
    'application/cloudevents+json': {
        unmarshall: buffer => JSON.parse('' + buffer),
        // unmarshall: buffer => {
        //     const env = JSON.parse('' + buffer);
        //     return [env.data, env]
        // }, // TODO: will this work?
        marshall: object => Buffer.from(JSON.stringify(object)) // TODO: do we want to write cloud events? I doubt it
    }
};
